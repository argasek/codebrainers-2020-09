...
function StudentList(props) {
 ...
 // CHcialem se tak zrobic ale cos nie bangla, a jutro robota :(
        ...
        //const niceToEyeName:
        // sortBy === "fullName" ? "Full student name" : 0 ;
        // sortBy === "numberOfBeers" ? "Number of Beers" :0 ;
...
// <th style={sortBy === "numberOfBeers" ? {backgroundColor: '#621'} : {backgroundColor: '#555'}}>Number of beers</th>
...
//
    ...
    return (
        <table className='student-table' cellSpacing="0" cellPadding="0">
            <thead>
            <tr>
                <th colspan={3} style={{backgroundColor: '#555'}}>Sort by {sortBy}, Direction
                    by: {sortDirectionHead}</th>
            </tr>
            <tr>
                <th style={backGroundAll}>Full name</th>
                <th style={backGroundBeer}>Number of
                    beers
                </th>
                <th style={backGroundParticipians}>Participation</th>
            </tr>
            </thead>
            <tbody>
            {
